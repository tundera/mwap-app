...
const supabaseKey = (_a = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYxODAxNTY4NiwiZXhwIjoxOTMzNTkxNjg2fQ.q91Sveo2Xa1lBjp3QfebfZZBzWG9sd6fyl0sKB3GLbw") != null ? _a : "";
...
function Navbar() {
  ...
  `;
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(StickyFlex, {
    bg,
    w: "full",
    px: {base: 2, sm: 4},
    py: 4,
...
const loader = () => __async(undefined, null, function* () {
  const {data: teams} = yield _lib_supabase__WEBPACK_IMPORTED_MODULE_0__.default.from("Team").select("*");
  return {
    teams,
    ttl: 604800
  };
